...
public class Cerveja {
    ...
    public  void setInformacao(String aMarca, String aTipo, double aPreco, String aFabricante, String ateorAlcoolico){
    this.marca = aMarca;
    this.tipo = aTipo;
    ...
    public void printCerveja(){
        ...
        System.out.println("Teor Alcóolico da Cerveja: "+teorAlcoolico);
        System.out.println("Codigo da Cerveja: "+codigo);
